...
def get_peaks(filename, penalty_power, num_harmonics):
...
print("File 1 (5428) - 5 Harmonics, Penalty 0.75")
print(get_peaks('RPM-Testdateien/1-5428.mp3', 0.75, 5))
print("File 1 (5428) - 5 Harmonics, Penalty 0.85")
print(get_peaks('RPM-Testdateien/1-5428.mp3', 0.85, 5))

print("\nFile 2 (5440) - 5 Harmonics, Penalty 0.75")
print(get_peaks('RPM-Testdateien/IMG_5440.MOV', 0.75, 5))
print("File 2 (5440) - 5 Harmonics, Penalty 0.85")
print(get_peaks('RPM-Testdateien/IMG_5440.MOV', 0.85, 5))
